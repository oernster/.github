...
These terms apply to every public repository under
[github.com/oernster](https://github.com/oernster) that does not carry its own CONTRIBUTING file.
...
3. **You grant a relicensing right.** You grant Oliver Ernster a perpetual, worldwide, irrevocable,
   royalty-free right to relicense your contribution, in whole or in part, under any terms of his
   choosing, including commercial or dual-licence terms. This keeps each project's licensing
   options intact as contributions arrive.
4. **Attribution is preserved.** Credit to the original author (Oliver Ernster) is retained in all
   copies and derivative works of these projects; a contribution must not remove or obscure it.
   Your own contribution is credited through the repository history.

If you cannot agree to these terms, open an issue describing the change instead of a pull request
and it may be implemented independently.
